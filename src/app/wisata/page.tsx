      ...
      <div className="max-w-7xl mx-auto px-6 py-24 pt-32">
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-lokara-gold">Explore Indonesia</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-ivory tracking-tighter leading-none mb-6">
            Destinasi <span className="text-gradient">Wisata</span>
          </h1>
          <p className="text-ivory/60 max-w-2xl text-lg font-medium">Eksplorasi keindahan alam dan budaya melalui destinasi wisata terpopuler yang telah kami kurasi khusus untuk Anda.</p>
        </div>
          ...
          <div className="space-y-12">
            <div className="flex items-center gap-4 p-6 rounded-[32px] bg-lokara-gold/5 border border-lokara-gold/10 backdrop-blur-md">
              ...
              <div>
                ...
                <p className="text-xs text-ivory/40">Menghubungkan data destinasi eksklusif...</p>
              </div>
            </div>
            <Skeleton />
          </div>
