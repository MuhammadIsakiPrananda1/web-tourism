      ...
      <div className="max-w-7xl mx-auto px-6 py-24 pt-32">
        <div className="mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-ivory tracking-tighter leading-none mb-6">
            Luxury <span className="text-gradient">Stays</span>
          </h1>
          <p className="text-ivory/60 max-w-2xl text-lg font-medium">Temukan penginapan terbaik untuk melengkapi perjalanan Anda dengan kenyamanan maksimal dan layanan kelas dunia.</p>
        </div>
          ...
          <div className="space-y-12">
            <div className="flex items-center gap-4 p-6 rounded-[32px] bg-lokara-gold/5 border border-lokara-gold/10 backdrop-blur-md">
              ...
              <div>
                ...
                <p className="text-xs text-ivory/40">Menghubungkan data akomodasi eksklusif...</p>
              </div>
            </div>
            <Skeleton />
          </div>
